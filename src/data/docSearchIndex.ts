...
const DOC_DEFS: DocDef[] = [
  ...
  },
  {
    ...
    sections: [
      { id: "overview", title: "Overview", snippet: "goBILDA ecosystem and FTC integration", terms: ["gobilda", "hardware", "overview"] },
      { id: "strafer-chassis", title: "Strafer Chassis", snippet: "goBILDA mecanum kit wiring and config", terms: ["strafer", "chassis", "mecanum", "kit"] },
      { id: "field-centric-drive", title: "Field-Centric Drive", snippet: "IMU-based field-centric with goBILDA drive", terms: ["field centric", "imu", "heading"] },
      { id: "viper-slide-intro", title: "Viper Slide Basics", snippet: "Viper linear slide hardware overview", terms: ["viper", "slide", "linear", "lift"] },
      { id: "viper-slide-code", title: "Viper Slide Programming", snippet: "Encoder limits and slide control code", terms: ["viper slide", "encoder", "limits", "programming"] },
      { id: "sensors", title: "Magnetic Limit Switch", snippet: "Digital magnetic limit switch wiring", terms: ["limit switch", "magnetic", "digital", "sensor"] },
      { id: "yellow-jacket-motors", title: "Yellow Jacket Motor Reference", snippet: "Gear ratios, ticks per revolution table", terms: ["yellow jacket", "gear ratio", "tpr", "ticks", "motor"] },
      { id: "led-lights", title: "LED Lights", snippet: "Addressable LED strips on goBILDA", terms: ["led", "lights", "rgb", "strip"] },
      { id: "imu", title: "IMU", snippet: "BNO055 IMU orientation and heading", terms: ["imu", "bno055", "heading", "yaw", "orientation"] },
      { id: "odometry-pods", title: "Odometry Pods & Pinpoint", snippet: "Dead wheels and Pinpoint odometry setup", terms: ["odometry", "pinpoint", "dead wheel", "localization"] },
    ],
  },
  {
    slug: "rev-robotics",
