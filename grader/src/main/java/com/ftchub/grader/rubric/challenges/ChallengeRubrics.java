...
public final class ChallengeRubrics {
    ...
    private static List<RubricRule> challenge2() {
        return Rules.of(
            ...
            Rules.improvement("Motor stopped after arriving",
                "setPower(0) releases the motor after RUN_TO_POSITION — optional but good practice.",
                "Optionally call motor.setPower(0) after the isBusy() loop to cut holding power.",
    ...
    private static List<RubricRule> challenge14() {
        return Rules.of(
            ...
            Rules.improvement("Motor stopped after arriving",
                "setPower(0) releases holding power after the encoder move.",
                "Optionally call motor.setPower(0) after the isBusy() loop.",
                ctx -> sourceContains(ctx, ZERO_POWER)),
